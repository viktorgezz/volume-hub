...
@Component
public class ClientFigiImpl implements ClientFigi {
    ...
    private static final Logger log = LoggerFactory.getLogger(ClientFigiImpl.class);

    private final RestTemplate restTemplate;

    @Autowired
    public ClientFigiImpl(
    ...
    @Override
    public List<String> fetchAllFigis() {
